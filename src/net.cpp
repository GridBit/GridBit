...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GridBit " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
unsigned int pnSeed[] =
{
    0xe4844d79, 0x825818ae, 0x2bd297a3, 0xd3b05d41, 0x70b03a80, 0x1d5f8221, 0xc81e00a8,
    0x90833b7, 0x51ca34cc, 0x1a5fa922, 0xd2bf3470, 0x3f7545f8, 0x69fb223f, 0x9eba9e9e,
    0xfdb93868, 0xb70f7833, 0x2d1dd7b, 0x138d9f0d, 0xf40ca114, 0x6a34532d, 0x96ba897c,
    0x3c707dc8, 0xd7454022, 0x49b3d3a5, 0x1e4f7738
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GridBit is probably already running."), addrBind.ToString().c_str());
        else
